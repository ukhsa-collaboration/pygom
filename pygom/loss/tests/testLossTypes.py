...
class TestLossTypes(TestCase):
    ...
    def test_FH_Square(self):
        ...
        objFH1 = SquareLoss(theta, ode, x0, t0, t, solution[1::,:],
                   ['V','R'], w)

        # now the weight is a vector
        w = numpy.random.rand(30, 2)
        objFH2 = SquareLoss(theta, ode, x0, t0, t, solution[1::,:],
                   ['V','R'], w)
    ...
    def test_FH_Normal(self):
        ...
        #objFH = squareLoss(theta,ode,x0,t0,t,solution[1::,1],'R')
        objFH = NormalLoss(theta, ode, x0, t0, t, solution[1::,:], ['V','R'])

        w = [2.0,3.0]
        objFH1 = NormalLoss(theta, ode, x0, t0, t, solution[1::,:],
                   ['V','R'], w)
       
        # now the weight is a vector
        w = numpy.random.rand(30, 2)
        objFH2 = NormalLoss(theta, ode, x0, t0, t, solution[1::,:],
                   ['V','R'], w)
    ...
    def test_FH_Square_1State_Fail(self):
        ...
        wList.append(numpy.random.rand(31))
        
        for w in wList:
            try:
                objFH = SquareLoss(theta, ode, x0, t0, t, solution[1::,:],
                                   'R', w)    
            except:
                totalFail += 1
