...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "depends": [],
        "name": "pygom.model._tau_leap",
        "sources": [
            "D:\\git\\pygom_github\\pygom\\model\\_tau_leap.pyx"
        ]
    },
    "module_name": "pygom.model._tau_leap"
}
END: Cython Metadata */
...
static PyObject *__pyx_pf_5pygom_5model_9_tau_leap__cy_test_tau_leap_safety(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_x, PyObject *__pyx_v_reactant_mat, PyObject *__pyx_v_rates, double __pyx_v_tau_scale, double __pyx_v_epsilon); /* proto */
...
static PyObject *__pyx_pw_5pygom_5model_9_tau_leap_1_cy_test_tau_leap_safety(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  PyObject *__pyx_v_reactant_mat = 0;
  ...
  __Pyx_RefNannySetupContext("_cy_test_tau_leap_safety (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_reactant_mat)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("_cy_test_tau_leap_safety", 1, 5, 5, 1); __PYX_ERR(0, 10, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_rates)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_cy_test_tau_leap_safety", 1, 5, 5, 2); __PYX_ERR(0, 10, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_tau_scale)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_cy_test_tau_leap_safety", 1, 5, 5, 3); __PYX_ERR(0, 10, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_epsilon)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_cy_test_tau_leap_safety", 1, 5, 5, 4); __PYX_ERR(0, 10, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "_cy_test_tau_leap_safety") < 0)) __PYX_ERR(0, 10, __pyx_L3_error)
      }
    ...
    __pyx_v_x = values[0];
    __pyx_v_reactant_mat = values[1];
    __pyx_v_rates = values[2];
    __pyx_v_tau_scale = __pyx_PyFloat_AsDouble(values[3]); if (unlikely((__pyx_v_tau_scale == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 10, __pyx_L3_error)
    __pyx_v_epsilon = __pyx_PyFloat_AsDouble(values[4]); if (unlikely((__pyx_v_epsilon == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 10, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("_cy_test_tau_leap_safety", 1, 5, 5, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 10, __pyx_L3_error)
  __pyx_L3_error:;
...
static PyObject *__pyx_pf_5pygom_5model_9_tau_leap__cy_test_tau_leap_safety(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_x, PyObject *__pyx_v_reactant_mat, PyObject *__pyx_v_rates, double __pyx_v_tau_scale, double __pyx_v_epsilon) {
 ...
 */
  __pyx_t_1 = __Pyx_PyObject_to_MemoryviewSlice_ds_double(__pyx_v_rates, PyBUF_WRITABLE); if (unlikely(!__pyx_t_1.memview)) __PYX_ERR(0, 18, __pyx_L1_error)
  __pyx_v_rates_view = __pyx_t_1;
  __pyx_t_1.memview = NULL;
  __pyx_t_1.data = NULL;

  /* "pygom/model/_tau_leap.pyx":19
 *     #view on arrays
 *     cdef double[:] rates_view = rates
 *     cdef int n_rates = rates.shape[0]             # <<<<<<<<<<<<<<
 *     cdef double[:] x_view = x
 ...
 */
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_v_rates, __pyx_n_s_shape); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 19, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_3 = __Pyx_GetItemInt(__pyx_t_2, 0, long, 1, __Pyx_PyInt_From_long, 0, 0, 0); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 19, __pyx_L1_error)
  ...
  __pyx_v_n_rates = __pyx_t_4;

  /* "pygom/model/_tau_leap.pyx":20
 *     cdef double[:] rates_view = rates
 *     cdef int n_rates = rates.shape[0]
 *     cdef double[:] x_view = x             # <<<<<<<<<<<<<<
 *     cdef int[:, :] reactant_mat_view = reactant_mat
 ...
 */
  __pyx_t_1 = __Pyx_PyObject_to_MemoryviewSlice_ds_double(__pyx_v_x, PyBUF_WRITABLE); if (unlikely(!__pyx_t_1.memview)) __PYX_ERR(0, 20, __pyx_L1_error)
  __pyx_v_x_view = __pyx_t_1;
  __pyx_t_1.memview = NULL;
  __pyx_t_1.data = NULL;

  /* "pygom/model/_tau_leap.pyx":21
 *     cdef int n_rates = rates.shape[0]
 *     cdef double[:] x_view = x
 *     cdef int[:, :] reactant_mat_view = reactant_mat             # <<<<<<<<<<<<<<
 *     cdef int n_reactants = reactant_mat.shape[0]
 * 
 */
  __pyx_t_5 = __Pyx_PyObject_to_MemoryviewSlice_dsds_int(__pyx_v_reactant_mat, PyBUF_WRITABLE); if (unlikely(!__pyx_t_5.memview)) __PYX_ERR(0, 21, __pyx_L1_error)
  __pyx_v_reactant_mat_view = __pyx_t_5;
  __pyx_t_5.memview = NULL;
  __pyx_t_5.data = NULL;

  /* "pygom/model/_tau_leap.pyx":22
 *     cdef double[:] x_view = x
 *     cdef int[:, :] reactant_mat_view = reactant_mat
 *     cdef int n_reactants = reactant_mat.shape[0]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_v_reactant_mat, __pyx_n_s_shape); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 22, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_2 = __Pyx_GetItemInt(__pyx_t_3, 0, long, 1, __Pyx_PyInt_From_long, 0, 0, 0); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 22, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_4 = __Pyx_PyInt_As_int(__pyx_t_2); if (unlikely((__pyx_t_4 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 22, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_v_n_reactants = __pyx_t_4;
 ...
 *     cdef int count = 0
 */
  __pyx_t_2 = __Pyx_PyObject_CallOneArg(__pyx_builtin_sum, __pyx_v_rates); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 25, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
 ...
 */
      __pyx_t_10 = __pyx_v_n_reactants;
 ...
 */
        ...
        __pyx_t_7 = (((*((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_reactant_mat_view.data + __pyx_t_13 * __pyx_v_reactant_mat_view.strides[0]) ) + __pyx_t_14 * __pyx_v_reactant_mat_view.strides[1]) ))) == 1) != 0);
        if (__pyx_t_7) {
 ...
 */
          ...
          __pyx_v_new_cdf = __pyx_fuse_0__pyx_f_5scipy_7special_14cython_special_pdtr(floor((*((double *) ( /* dim=0 */ (__pyx_v_x_view.data + __pyx_t_16 * __pyx_v_x_view.strides[0]) )))), __pyx_v_mu, 0);
 ...
 *         count += 1
 */
    __pyx_t_17 = (((__pyx_v_tau_scale * __pyx_v_total_rate) <= 1.0) != 0);
    if (!__pyx_t_17) {
    } else {
      __pyx_t_7 = __pyx_t_17;
      goto __pyx_L14_bool_binop_done;
    }
    __pyx_t_17 = ((__pyx_v_count > 0x100) != 0);
    __pyx_t_7 = __pyx_t_17;
 ...
 */
  ...
  /* "pygom/model/_tau_leap.pyx":55
 *         count += 1
 * 
 *     return tau_scale, True             # <<<<<<<<<<<<<<
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_2 = PyFloat_FromDouble(__pyx_v_tau_scale); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 55, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
 ...
 *     Additional safety test on :math:`\\tau`-leap, decrease the step size if
 */
  __pyx_tuple__19 = PyTuple_Pack(19, __pyx_n_s_x, __pyx_n_s_reactant_mat, __pyx_n_s_rates, __pyx_n_s_tau_scale, __pyx_n_s_epsilon, __pyx_n_s_rates_view, __pyx_n_s_n_rates, __pyx_n_s_x_view, __pyx_n_s_reactant_mat_view, __pyx_n_s_n_reactants, __pyx_n_s_mu, __pyx_n_s_max_cdf, __pyx_n_s_new_cdf, __pyx_n_s_total_rate, __pyx_n_s_safe, __pyx_n_s_count, __pyx_n_s_cdf_val, __pyx_n_s_i, __pyx_n_s_j); if (unlikely(!__pyx_tuple__19)) __PYX_ERR(0, 10, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__19);
  __Pyx_GIVEREF(__pyx_tuple__19);
  __pyx_codeobj__20 = (PyObject*)__Pyx_PyCode_New(5, 0, 19, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__19, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_pygom_model__tau_leap_pyx, __pyx_n_s_cy_test_tau_leap_safety, 10, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__20)) __PYX_ERR(0, 10, __pyx_L1_error)
 ...
 *     Additional safety test on :math:`\\tau`-leap, decrease the step size if
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_5pygom_5model_9_tau_leap_1_cy_test_tau_leap_safety, NULL, __pyx_n_s_pygom_model__tau_leap); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 10, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_cy_test_tau_leap_safety, __pyx_t_1) < 0) __PYX_ERR(0, 10, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
