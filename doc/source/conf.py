# -*- coding: utf-8 -*-
#
# pyGenericOdeModelDoc documentation build configuration file, created by
...
project = u'PyGOM Documentation'
copyright = u'2015-2017, Edwin Tye'
...
latex_documents = [
  ('index', 'PyGOM.tex', u'PyGOM Documentation',
   u'Edwin Tye', 'manual'),
]
